...
namespace jadeface
{
    public partial class App : Application
    {
        ...
        public static MobileServiceClient MobileService = new MobileServiceClient(
            "https://jadeface.azure-mobile.net/",
            "nicdvzpvLaKzHKIOGFAVhnSVfqCpzo55"
            );
        ...
        private void LoadState()
        {
            ...
            {
                phoneAppServeice.State["username"] = username;
            }
             * */
            phoneAppServeice.State["username"] = "dreamxiah@gmail.com";
            Debug.WriteLine("[DEBUG]Username is : " + phoneAppServeice.State["username"]);
        }
